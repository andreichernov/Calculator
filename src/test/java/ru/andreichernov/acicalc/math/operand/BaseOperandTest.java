...
public class BaseOperandTest {
    ...
    public void isAvailableDigitInArabic() throws Exception {
        ...
        assertEquals(true, baseOperand.isAvailableDigit(codepointOf0));

        int codepointOfR = "R".codePointAt(0);
        assertEquals(false, baseOperand.isAvailableDigit(codepointOfR));
    ...
    public void isAvailableDigitInRoman() throws Exception {
        ...
        int codepointOf0 = "0".codePointAt(0);
        assertEquals(false, baseOperand.isAvailableDigit(codepointOf0));

        int codepointOfX = "X".codePointAt(0);
        assertEquals(true, baseOperand.isAvailableDigit(codepointOfX));
